...
// Copyright (c) 2013 The Offering developers
...
uint256 hashGenesisBlock("0x000006829ac5ad04fb30abfcbf6d927c67c30fc2f198fb0bdce5a0c914b091b5");
static const unsigned int timeGenesisBlock = 1379187075;
...
const string strMessageMagic = "Offering Signed Message:\n";
...
static const int64 nGenesisBlockRewardCoin = 10000 * COIN;
static const int64 nBlockRewardStartCoin = 5 * COIN;
static const int64 nBlockRewardMinimumCoin = .01 * COIN;
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
    ...
    if (nHeight == 1) {return nGenesisBlockRewardCoin;} //an Offering of cosmic proportion to bring the return of the Great Old One.
    
	else if(nHeight == 1440) {nSubsidy = .00000001 * COIN;} //the first week of the ritual is about sacrifice
    else if(nHeight == 2880) {nSubsidy = .0000001 * COIN;}
    else if(nHeight == 4320) {nSubsidy = .000001 * COIN;}
    else if(nHeight == 5760) {nSubsidy = .00001 * COIN;}
    else if(nHeight == 7200) {nSubsidy = .0001 * COIN;}
    else if(nHeight == 8640) {nSubsidy = .001 * COIN;}
    else if(nHeight == 10080) {nSubsidy = .01 * COIN;}
    else if(nHeight == 11520) {nSubsidy = 1 * COIN;} //the second week of the ritual is about acceptance
    else if(nHeight == 12960) {nSubsidy = 1 * COIN;}
    else if(nHeight == 14400) {nSubsidy = 1 * COIN;}
    else if(nHeight == 15840) {nSubsidy = 1 * COIN;}
    else if(nHeight == 17280) {nSubsidy = 1 * COIN;}
    else if(nHeight == 18720) {nSubsidy = 1 * COIN;}
    else if(nHeight == 20160) {nSubsidy = 1 * COIN;}
    else if(nHeight == 21600) {nSubsidy = 10 * COIN;} //the third week of the ritual is breeds greed
    else if(nHeight == 23040) {nSubsidy = 10 * COIN;}
    else if(nHeight == 24480) {nSubsidy = 10 * COIN;}
    else if(nHeight == 25290) {nSubsidy = 10 * COIN;}
    else if(nHeight == 27360) {nSubsidy = 10 * COIN;}
    else if(nHeight == 28800) {nSubsidy = 10 * COIN;}
    else if(nHeight == 30240) {nSubsidy = 10 * COIN;}
    else if(nHeight == 31680) {nSubsidy = 100 * COIN;} //the fourth week of the ritual heightens fervor
    else if(nHeight == 33120) {nSubsidy = 100 * COIN;}
    else if(nHeight == 34560) {nSubsidy = 100 * COIN;}
    else if(nHeight == 36000) {nSubsidy = 100 * COIN;}
    else if(nHeight == 37440) {nSubsidy = 100 * COIN;}
    else if(nHeight == 38880) {nSubsidy = 100 * COIN;}
    else if(nHeight == 40320) {nSubsidy = 100 * COIN;}
    else if(nHeight == 41760) {nSubsidy = 1000 * COIN;} //finally the ritual enters its most rewarding stage
    else if(nHeight == 43200) {nSubsidy = 1000 * COIN;}
    else if(nHeight == 44640) {nSubsidy = 1000 * COIN;}
    else if(nHeight == 46080) {nSubsidy = 1000 * COIN;}
	else if(nHeight == 50666) {nSubsidy = 10000 * COIN;} //i can see everything
	
	//during the equinox, after the first great halving, the great ritual will be attempted once again
	else if(nHeight == 261440) {nSubsidy = .00000001 * COIN;}
    else if(nHeight == 262880) {nSubsidy = .0000001 * COIN;}
    else if(nHeight == 264320) {nSubsidy = .000001 * COIN;}
    else if(nHeight == 265760) {nSubsidy = .00001 * COIN;}
    else if(nHeight == 267200) {nSubsidy = .0001 * COIN;}
    else if(nHeight == 268640) {nSubsidy = .001 * COIN;}
    else if(nHeight == 270080) {nSubsidy = .01 * COIN;}
    else if(nHeight == 271520) {nSubsidy = 1 * COIN;}
    else if(nHeight == 272960) {nSubsidy = 1 * COIN;}
    else if(nHeight == 274400) {nSubsidy = 1 * COIN;}
    else if(nHeight == 275840) {nSubsidy = 1 * COIN;}
    else if(nHeight == 277280) {nSubsidy = 1 * COIN;}
    else if(nHeight == 278720) {nSubsidy = 1 * COIN;}
    else if(nHeight == 280160) {nSubsidy = 1 * COIN;}
    else if(nHeight == 281600) {nSubsidy = 10 * COIN;}
    else if(nHeight == 283040) {nSubsidy = 10 * COIN;}
    else if(nHeight == 284480) {nSubsidy = 10 * COIN;}
    else if(nHeight == 285290) {nSubsidy = 10 * COIN;}
    else if(nHeight == 287360) {nSubsidy = 10 * COIN;}
    else if(nHeight == 288800) {nSubsidy = 10 * COIN;}
    else if(nHeight == 290240) {nSubsidy = 10 * COIN;}
    else if(nHeight == 291680) {nSubsidy = 100 * COIN;}
    else if(nHeight == 293120) {nSubsidy = 100 * COIN;}
    else if(nHeight == 294560) {nSubsidy = 100 * COIN;}
    else if(nHeight == 296000) {nSubsidy = 100 * COIN;}
    else if(nHeight == 297440) {nSubsidy = 100 * COIN;}
    else if(nHeight == 298880) {nSubsidy = 100 * COIN;}
    else if(nHeight == 300320) {nSubsidy = 100 * COIN;}
    else if(nHeight == 301760) {nSubsidy = 1000 * COIN;}
    else if(nHeight == 303200) {nSubsidy = 1000 * COIN;}
    else if(nHeight == 304640) {nSubsidy = 1000 * COIN;}
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000dfe4a288de75c3000947748c69b240a9eec9187f67510c558b58468dd8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        block.print();
        assert(block.hashMerkleRoot == uint256("0xb3f4e4e9bbae6f63a0693661c510a33dca69489bfff65a88aaeb85f30d30b485"));
...
unsigned char pchMessageStart[4] = { 0x03, 0xa5, 0xfe, 0xdd };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("OfferingMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("OfferingMiner : ProcessBlock, block not accepted");
    }
